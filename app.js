...
class RunningCoach {
    ...
    gerarPlanoTreino() {
        ...
        // Teto de volume controlado para evitar picos abruptos em prazos longos
        ...
        // Pré-calcula a progressão contínua semana a semana
        let volumesSemanais = [];
        ...
        for (let i = 0; i <= diasTotais; i++) {
            ...
            if (i === diasTotais) {
                ...
                if(tipo === "Tempo Run") {
                    ...
                    distancia = Math.max(4, volSemanalAtual * (pctTempo * 0.9));
